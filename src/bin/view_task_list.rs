// Generating the task list right now actually executes actions like buying ships, which has obvious adverse effect if the script is running elsewhere
// so this script is disabled until it doesn't interfere.
...
//         .task_manager
//         .generate_task_list(10000)
//         .await;
//     debug!("Generated: {} tasks", task_list.len());
...
//             debug!("ASSIGNED TO SHIP: {} at {}", &ship, ts);
//         } else {
//             debug!("UNASSIGNED");
//         }
//     }
